...
// Функция для деления большого числа на маленькое число: quotient = dividend / divisor
void big_integer_divide_small(int dividend[], int divisor, int quotient[]);

// Функция для преобразования большого числа в строку
string big_integer_to_string(int num[]);
